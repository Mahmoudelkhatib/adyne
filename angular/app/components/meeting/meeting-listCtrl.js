angular
    ...
    {
        MeetingFactory.resource().delete({"id" : id})
      
        $http.get("http://localhost:3000/meeting").success(function(data){
...
for(var i=0; i<$scope.dt_data.length; i++ ) 
    ...
    $scope.create = function()
    {
       ...
       $resource('http://localhost:3000/meeting')
                .query()
                .$promise
    ...
    $scope.randID_generator = function() {
            ...
            $scope.eventSources = [$resource("http://localhost:3000/meeting/calendar").query()]; 
