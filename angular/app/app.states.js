    ...
    .config([
        ...
        function ($stateProvider, $urlRouterProvider) {
           ...
           .state("restricted.events", {
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                ...
                                'lazy_fullcalendar',
                                'lazy_datatables',
                                'app/components/events/eventsCtrl.js'
                            ]);
                        }]
                    },
                    data: {
            ...
            .state("restricted.event_edit", {
                    url: "/event_edit/:id",
                    templateUrl: 'app/components/events/event_edit.html',
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                'lazy_wizard',
                                'lazy_tinymce',
                                'app/components/events/event_editCtrl.js'
                            ], {serie:true});
                        }]
                    },
                    data: {
            ...
            .state("restricted.event_create", {
                    url: "/event_create",
                    templateUrl: 'app/components/events/event_create.html',
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                'lazy_wizard',
                                'lazy_tinymce',
                                'app/components/events/event_createCtrl.js'
                            ], {serie:true});
                        }]
                    },
                    data: {
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                'lazy_datatables',
                                'lazy_google_maps',
                                'app/components/events/event_detailCtrl.js'
                            ],{serie: true});
                        }]
                    },
                data: {
            ...
            .state("restricted.meeting", {
                    url: "/meeting-list",
                    templateUrl: 'app/components/meeting/meeting-list.html',
                    controller:"meeting-listCtrl",
                ...
                resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                ...
                                'lazy_datatables',
                                'lazy_fullcalendar',
                                'app/components/meeting/meeting-listCtrl.js',
                                'lazy_tinymce',
            ...
            .state("restricted.create", {
                    url: "/meeting-create",
                    templateUrl: 'app/components/meeting/meeting-create.html',
                    controller: 'meeting-createCtrl',
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                'lazy_parsleyjs',
                                'lazy_tinymce',
                                'app/components/meeting/meeting-createCtrl.js'
                            ]);
                        }]
                    },
                    data: {
            ...
            .state("restricted.edit ", {
                    url: "/meeting-edit/:id",
                    templateUrl: 'app/components/meeting/meeting-edit.html',
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                'lazy_parsleyjs',
                                'lazy_tinymce',
                                'app/components/meeting/meeting-editCtrl.js'
                            ]);
                        }]
                    },
                    data: {
             ...
             .state("restricted.contact_list", {
                    url: "/contacts_list",
                    templateUrl: 'app/components/members/members_list.html',
                    controller: 'members_listCtrl',
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                'app/components/members/members_listCtrl.js'
                            ],{serie: true});
                        }],
                        contact_list: function($http){
                            return $http({ method: 'GET', url: 'data/contact_list.json' })
            ...
            .state("restricted.member", {
                    url: "/contact_create",
                    templateUrl: 'app/components/members/membre_create.html',
                    controller: 'member_createCtrl',
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                'lazy_parsleyjs',
                                'app/components/members/member_createCtrl.js'
                            ]);
                        }],
                        user_data: function($http){
                            return $http({ method: 'GET', url: 'data/user_data.json' })
            ...
            .state("restricted.contact_profile", {
                    url: "/contact_profil/:id",
                    templateUrl: 'app/components/members/membre_detail.html',
                    controller: 'membre_detailCtrl',
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                'app/components/members/membre_detailCtrl.js'
                            ]);
                        }],
                        user_data: function($http){
                            return $http({ method: 'GET', url: 'data/user_data.json' })
